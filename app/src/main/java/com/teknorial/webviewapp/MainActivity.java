...
import static com.teknorial.webviewapp.R.id.button1;
import static com.teknorial.webviewapp.R.id.button2;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.loadUrl("http://www.3logicsoftware.com/spark/index.php"); //try js alert
    ...
    public void addButtonClickListner() {
        Button btnNavigator = (Button) findViewById(button1);
        btnNavigator.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg) {
                view.loadUrl("javascript:myJSFunction()");
            }
        });



        Button btnNavigator2 = (Button) findViewById(button2);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.teknorial.webviewapp/http/host/path")
        );
